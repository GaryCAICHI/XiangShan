...
object Zvbaseband{
  def VSCMUL_VV     = BitPat("b110010???????????000?????1010111")
  def VSCMULCJ_VV   = BitPat("b110011???????????000?????1010111")
  def VSCMACC_VV    = BitPat("b110100???????????000?????1010111")
  def VSCMACCCJ_VV  = BitPat("b110110???????????000?????1010111")
  def VSCADDCONJ_VV = BitPat("b110111???????????000?????1010111")
  def VSCADDRQ_VV   = BitPat("b111000???????????000?????1010111")
  def VSCADDRTQ_VV  = BitPat("b111001???????????000?????1010111")
}
